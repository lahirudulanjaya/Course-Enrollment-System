 ...
 */
public class Show_postgraduate extends javax.swing.JFrame {

    /**
     * Creates new form Show_undergraduate
     */
    public Show_postgraduate() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student Id", "Full Name", "Age", "Gender", "Address", "Date of Birth", "Phone number", "Degree", "Institute"
            }
        ));
        jScrollPane1.setViewportView(table);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 920, 470));
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        try {
            ...
            tbl.setRowCount(0);
            for(Postgraduate st : students){
                
                Object[] Data={st.getAdmission_number(),st.getName(),st.getAge(),st.getGender(),st.getAddress(),st.getDOB(),st.getPhone_number(),st.getDegree(),st.getInstitute()};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Show_postgraduate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Show_postgraduate().setVisible(true);
            }
        });
    }
