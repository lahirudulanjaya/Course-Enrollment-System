 ...
 */
public class Choose_Subject_Undergraduate extends javax.swing.JFrame {

    /**
     * Creates new form Choose_Subject_Undergraduate
     */
    public static int attempt=0;
    public Choose_Subject_Undergraduate() {
        initComponents();
        if(Choose_Subject_Undergraduate.attempt==1){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Choose Subjects");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 0, 206, 31));
    ...
    private void viewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewActionPerformed
            ...
            try {
                ...
                if(Selected_Subject_controll.allreadyexists(id.getText())==true){
                    confirm.setVisible(false);
                    JOptionPane.showMessageDialog(jMenu1,"you have already add subjects");
                }
                
            } catch (SQLException ex) {
                Logger.getLogger(Choose_Subject_Undergraduate.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void confirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmActionPerformed
      if(getsum()!=4){  
         ...
         try {
         if(Selected_Subject_controll.allreadyexists(id.getText())==false){
          for(int i=0;i<Table.getRowCount();i++){
           ...
           for(int i=0;i<Table1.getRowCount();i++){
              Selected_Subjects ss =new Selected_Subjects();
              ss.setSubject_code((String) Table1.getValueAt(i,0));
              ss.setStudent_id(id.getText());
              ss.setCompulsory(true);
                  Selected_Subject_controll.add_subject(ss); 
           ...
           JOptionPane.showMessageDialog(jMenu1, "Success");
              ...
              JOptionPane.showMessageDialog(jMenu1, "you have already chosen");
         }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Choose_Subject_Undergraduate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable(){
            public void run() {
                new Choose_Subject_Undergraduate().setVisible(true);
            }
        });
    }
    public int getsum(){
