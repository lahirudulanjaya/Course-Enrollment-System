 ...
 */
public class Show_Instructors extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Instructor Id", "Full Name", "Age", "Gender", "Address", "Date of Birth", "Phone number", "Lab No", "Subject"
            }
        ));
        ...
        jToggleButton1.setText("Show Instructors");
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        try {
            ...
            ArrayList<Instructor> lec = Instructor_controll.getall();
            DefaultTableModel tbl = (DefaultTableModel) table.getModel();
            tbl.setRowCount(0);
            for(Instructor st : lec){
                
                Object[] Data={st.getInstructor_id(),st.getName(),st.getAge(),st.getGender(),st.getAddress(),st.getDOB(),st.getPhone_number(),st.getLab_num(),st.getSubjects()};
            ...
            Logger.getLogger(Show_Instructors.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_jToggleButton1ActionPerformed

    private void jToggleButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton2ActionPerformed
       this.dispose();
        Admin_Instructor ad = new Admin_Instructor();
        ad.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Show_Instructors.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Show_Instructors().setVisible(true);
            }
        });
    }
