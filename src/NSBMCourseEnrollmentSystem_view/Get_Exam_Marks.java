 ...
 */
public class Get_Exam_Marks extends javax.swing.JFrame {

    /**
     * Creates new form Assignment_Marks
     */
    public Get_Exam_Marks() throws SQLException {
        initComponents();
    ...
    private void resultActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_resultActionPerformed
        try {
            ...
            tb2.setRowCount(0);
            for(Exam as: result_list){
                Object[] Data={as.getSubject_code(),as.getExam_marks(),as.getExam_grade()};
                tb2.addRow(Data);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Get_Exam_Marks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Get_Exam_Marks().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(Get_Exam_Marks.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
