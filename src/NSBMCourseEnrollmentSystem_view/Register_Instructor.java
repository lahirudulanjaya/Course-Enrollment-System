 ...
 */
public class Register_Instructor extends javax.swing.JFrame {

    /**
     * Creates new form Register_Postgraduate
     */
    public Register_Instructor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Register  Instructor");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 20, 390, 40));
        ...
        jPanel1.add(ins_id, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, 320, 30));
    ...
    private void RegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegisterActionPerformed
        ...
        us.setInstructor_id(ins_id.getText());
        ...
        us.setLab_num(Integer.parseInt(room.getText()));
        us.setEmail(email.getText());
        us.setSubjects(subject.getSelectedItem().toString());

        try {
            Instructor_controll.add(us);
    ...
    private void courseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_courseActionPerformed
        try {
            ...
            Logger.getLogger(Register_Instructor.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Register_Instructor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Register_Instructor().setVisible(true);
            }
        });
    }
